...
cwd = '/Users/dstark/supercal/09575/satellites'
image_dir = cwd + '/../'
        ...
        for ext in [1, 4]:
            ...
            if len(catalog) == 0:
                ...
                for row in catalog:
                    ...
                    segmentation_file_4 = '/Users/dstark/supercal/09575/satellites/{}_ext{}_mrt_segment.fits'.format(root, ext)
                    segmentation_file_1 = '/Users/dstark/supercal/09575/satellites/{}_ext{}_mrt_segment.fits'.format(root, ext)
...
if remake_image_diagnostics:
    ...
    for root in roots:
        ...
        segmentation_file_4 = '/Users/dstark/supercal/09575/satellites/{}_ext{}_mrt_segment.fits'.format(root, 4)
        segmentation_file_1 = '/Users/dstark/supercal/09575/satellites/{}_ext{}_mrt_segment.fits'.format(root, 1)
        segment_wfc1 = fits.getdata(segmentation_file_4)
        segment_wfc2 = fits.getdata(segmentation_file_1)
